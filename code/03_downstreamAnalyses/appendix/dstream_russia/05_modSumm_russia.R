...
ggsave(agreeFixedDistract, width=8, height=4,
  file=paste0(pathPaper, 'agreeFixedDistract_russia.pdf'),
  device=cairo_pdf)
ggsave(tradeFixedDistract, width=8, height=4,
  file=paste0(pathPaper, 'tradeFixedDistract_russia.pdf'),
  device=cairo_pdf)
ggsave(agreeVarDistract, width=8, height=8,
  file=paste0(pathPaper, 'agreeVarDistract_russia.pdf'),
  device=cairo_pdf)
ggsave(tradeVarDistract, width=8, height=8,
  file=paste0(pathPaper, 'tradeVarDistract_russia.pdf'),
  device=cairo_pdf)
####
