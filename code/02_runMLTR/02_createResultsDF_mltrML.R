...
diplomScoresAgree = processMLTR_ML(
	yrs=1980:2019,
	fname='diplomScores_agree_ML.rda')

#
econScoresTradeDep = processMLTR_ML(
	yrs=1995:2020,
	fname='econScores_tradeDepSend_ML.rda')

#
icewsScoresGov = processMLTR_ML(
	yrs=2000:2020,
	fname='icewsScores_gov_ML.rda')
####
...
mltrScores_ML = frame
save(mltrScores_ML,
	file=paste0(pth, 'results/mltrScores_ML.rda') )
####
