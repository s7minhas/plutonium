...
ggsave(agreeFixedDistract, width=8, height=4,
  file=paste0(gpth, 'agreeFixedDistract_k5.pdf'),
  device=cairo_pdf)
ggsave(agreeFixedDistract, width=8, height=4,
  file=paste0(gpth, 'agreeFixedDistract_k5.png'),
  dpi=600)
ggsave(agreeVarDistract, width=8, height=8,
  file=paste0(gpth, 'agreeVarDistract_k5.pdf'),
  device=cairo_pdf)
ggsave(agreeVarDistract, width=8, height=8,
  file=paste0(gpth, 'agreeVarDistract_k5.png'),
  dpi=600)
####
