...
####
load(paste0(dpth, "modData_russia.rda"))
...
if(!file.exists(paste0(rpth, 'lmerModsFin_russia.rda'))){
	...
	####
	save(lmerMods, file=paste0(rpth, 'lmerModsFin_russia.rda'))
}
####
