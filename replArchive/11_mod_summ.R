...
load(paste0(rpth, 'lmerModsFin.rda'))
####
...
ggsave(agreeFixedDistract, width=8, height=4,
  file=paste0(gpth, 'agreeFixedDistract.pdf'),
  device=cairo_pdf)
ggsave(agreeFixedDistract, width=8, height=4,
  file=paste0(gpth, 'agreeFixedDistract.png'),
  dpi=600)
ggsave(agreeVarDistract, width=8, height=8,
  file=paste0(gpth, 'agreeVarDistract.pdf'),
  device=cairo_pdf)
ggsave(agreeVarDistract, width=8, height=8,
  file=paste0(gpth, 'agreeVarDistract.png'),
  dpi=600)
####
