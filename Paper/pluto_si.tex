...
\title{Decisive or Distracted: the Effects of United States Constraint on Security Networks --- Supplementary Materials}
...
\begin{abstract}
\singlespacing{
This document contains supplementary materials for ``Decisive or Distracted: the Effects of United States Constraint on Security Networks.'' It includes additional details on the construction of the US distraction index, robustness checks with alternative model specifications, results for alignment with Russia, sensitivity analyses with varying dimensionality of the latent factor model, and simulation studies validating our measurement approach.}
