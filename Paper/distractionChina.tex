...
\graphicspath{
  ...
  {/Users/s7m/Dropbox/Research/victimization/graphics/},
  {/Users/dorffc/Dropbox/Research/nothingbutnet/victimization/graphics/},
  {/Users/maxgallop/Dropbox/intraConfNetDyn/graphics/}
}
...
\title{Hegemonic Distraction and }
...
\begin{abstract}
\singlespacing{
%In recent years there has been increasing consensus that the decision by armed groups to kill civilians is not simply a byproduct of ancient primordial hatreds, but is rather a strategic choice.

We do stuff, its pretty cool. \\
...
\end{abstract}
 ...
 % \tnotetext[t1]{\noindent Alphabetical order signifies equal authorship, all mistakes are our own. Replication material and instructions will be made available at \url{https://github.com/s7minhas/victimization}.}
