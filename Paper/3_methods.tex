...
\textcolor{blue}{Should add citations to this table}
...
\begin{figure}[h]
    \centering
    \includegraphics{activeconf.png}
    \caption{Constraint due to Active US Conflicts (F1)}
    \label{fig:my_label}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics{f2plot.png}
    \caption{Constraint due to US Defense Spending/Commitments (F2)}
    \label{fig:my_label}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics{f3plot.png}
    \caption{Constraint due to Economic Shocks (F3)}
    \label{fig:my_label}
\end{figure}
...
\textcolor{red}{SM: Please include circle plots for both LFMs for 2000 and 2019/2020, with countries highlighted as in the word doc.}
...
\textcolor{red}{SM: please include the US/UK, US/China, US/Russia time series for our variables here as in the word doc.}
