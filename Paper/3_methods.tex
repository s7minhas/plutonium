...
As noted above, we have developed a measure of US constraint to capture a variety of mechanisms that might limit US action. In broad terms, we operationalize constraint as a function of three possible sources:
